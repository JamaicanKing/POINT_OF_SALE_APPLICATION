        ...
        <div class="span2">
            ...
            <div class="span10">
                ...
                <div style="margin-top: -19px; margin-bottom: 21px;">
                    <a href="../auth.php"><button class="btn btn-default btn-large" style="float: left;"><i class="icon icon-circle-arrow-left icon-large"></i> Back</button></a>
                    <?php
                    include_once('../Database/Connection.php');
                    $conn = new dbConnection;
                    $connection = $conn->connect("root", "localhost", "password", "stockWiz");
                    $result = $connection->query("SELECT * FROM products ORDER BY qty_sold DESC");
                    ...
                    <?php
                    include_once('../Database/Connection.php');
                    $result2 = $connection->query("SELECT * FROM products where qty < 10 ORDER BY product_id DESC");
                    ...
                    <div style="text-align:center;">
                        Total Number of Products: <font color="green" style="font:bold 22px 'Aleo';">[<?php echo $result->num_rows; ?>]</font>
                    </div>

                    <div style="text-align:center;">
                        <font style="color:rgb(255, 95, 66);; font:bold 22px 'Aleo';">[<?php echo $result2->num_rows; ?>]</font> Products are below QTY of 10
                    </div>
                </div>
                ...
                <table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
                    ...
                    <tbody>
                        ...
                        $conn = new dbConnection;
                        $connection = $conn->connect("root", "localhost", "password", "stockWiz");
                        $result3 = $connection->query("SELECT *, price * qty as total FROM products ORDER BY product_id DESC");
