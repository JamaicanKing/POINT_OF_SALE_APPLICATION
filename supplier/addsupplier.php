...
if (isset($_POST['name']) && isset($_POST['address']) && isset($_POST['contact']) && isset($_POST['cperson']) && isset($_POST['note'])) {
    include '../models/supplierClass.php';
    $supplier = new suppliers;
    echo $supplier->saveSuppier($_POST['name'],$_POST['address'],$_POST['contact'],$_POST['cperson'],$_POST['note']);
}
