		...
		<div class="span2">
			...
			<div class="span10">
				...
				<div style="margin-top: -19px; margin-bottom: 21px;">
					...
					$result = $connection->query("SELECT * FROM customer ORDER BY customer_id DESC");
					...
					<div style="text-align:center;">
						Total Number of Customers: <font color="green" style="font:bold 22px 'Aleo';"><?php echo $result->num_rows; ?></font>
					</div>
				</div>
